<div class="container card bg-light p-t-50 p-r-50 p-l-50 p-b-50">
    <form method="POST" @if ($type=='insert' or $type=='update' )action="{{ route($route) }}" @endif>
        {{ csrf_field() }}
        @if ( $type == 'update')
        {{ method_field('PUT') }}
        @endif
        <div class="row">
            <div class="form-group col-md-5">
                ...
                <input type="text" name="cod-product" class="form-control" id="cod_product" @if($type=='update' )
                    ...
                    @else value="{{old('cod-product')}}" @endif
            ...
            <div class="form-group col-md-7">
                ...
                <div>
                    <select name="category-product" class="form-control" required @if ($type=='info' ) disabled @endif>
                        ...
                        <option @if (($type=='update' or $type=='info') && $c->idcategory == $product->category_idcategory) selected @endif
        ...
        <div class="row">
            <div class="form-group col-md-6">
                ...
                <input type="text" name="model-product" class="form-control" id="model_product" @if($type=='update' or $type=='info' )
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" name="brand-product" class="form-control" id="brand_product" @if($type=='update' or $type=='info' )
        ...
        <div class="row">
            <div class="form-group col-md-6">
                ...
                <input type="number" min="0" name="price-product" class="form-control" id="price_product" @if($type=='update' )
                    value="{{$product->price}}"  @elseif($type=='info' ) value="{{$product->price}}" readonly @else  value="{{old('price-product')}}" @endif
                    placeholder="Ingrese precio base" required>
            </div>
            <div class="form-group col-md-6">
                <label for="lenght_product">Longitud(mm):</label>
                <input type="number" step="0.01" min="0" name="lenght-product" class="form-control" id="lenght_product" @if($type=='update' )
                    value="{{$product->lenght}}"   @elseif($type=='info' ) value="{{$product->lenght}}" readonly @else value="{{old('lenght-product')}}" @endif
        ...
        <div class="row">
            <div class="form-group col-md-6">
                ...
                <input type="number" step="0.01" min="0" name="hight-product" class="form-control" id="hight_product" @if($type=='update' )
                    value="{{$product->hight}}"   @elseif($type=='info' ) value="{{$product->hight}}" readonly @else value="{{old('hight-product')}}" @endif
                    placeholder="Ingrese altura" required>
            </div>
            <div class="form-group col-md-6">
                <label for="widht_product">Ancho(mm):</label>
                <input type="number" step="0.01" min="0" name="widht-product" class="form-control" id="widht_product" @if($type=='update' )
                    value="{{$product->widht}}"  @elseif($type=='info' ) value="{{$product->widht}}" readonly @else value="{{old('widht-product')}}" @endif
