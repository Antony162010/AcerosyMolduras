...
@section('scripts')
<script type="text/javascript" src="{{ asset('js/pdfIndex.js') }}"></script>
@endsection
@section('assets')
...
<div class="container card bg-light p-t-50 p-r-50 p-l-50 p-b-50">
    <form method="POST" action="{{ route('store_house.catalog') }}">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-3"><button type="button" id="add_product" class="btn btn-primary">Escoger
